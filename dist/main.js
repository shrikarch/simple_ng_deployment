...
module.exports = "<app-navbar *ngIf=\"loggedIn\"></app-navbar>\r\n<app-login (loggedIn)=\"onLogIn($event)\" *ngIf=\"!loggedIn\"></app-login>\r\n<router-outlet *ngIf=\"loggedIn\"></router-outlet>\r\n<app-footer></app-footer>\r\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onLogIn = function (status) {
...
module.exports = "<div class=\"container-fluid login-container\" style=\"height: 100%;\">\n  <div class=\"row justify-content-center\" >\n    <div class=\"col-md-4\">\n      <div class=\"card login-card\">\n        <div class=\"card-body-wrapper\" style=\"padding-top: 10%\">\n          <div class=\"card-body\">\n            <div class=\"row\">\n              <div class=\"col-md-12 pt-2 text-center\">\n                <div class=\" text-uppercase login-header\">\n                  Genesco\n                </div>\n                <div class=\"login-headline\">\n                  Single View of the Customer\n                </div>\n                <div class=\"login-text small\">\n                  A comprehensive customer lookup solution\n                </div>\n              </div>\n            </div>\n            <div class=\"row justify-content-center mt-5\">\n              <div class=\"col-md-11 text-center\">\n                <div class=\"form-group\" style=\"width: 100%\">\n                  <input type=\"text\" class=\"form-control\" type=\"text\" placeholder=\"Username or Email\">\n                </div>\n                <div class=\"form-group\" style=\"width: 100%\">\n                  <input type=\"text\" class=\"form-control\" type=\"password\" placeholder=\"Password\">\n                </div>\n                <div class=\"form-group pt-4\" style=\"width: 100%\">\n                  <button class=\"btn btn-outline-default btn-block\" (click)=\"logIn()\">Log In</button>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
module.exports = "@font-face {\n  font-family: 'Crimson Text';\n  font-style: normal;\n  font-weight: 600;\n  src: local('Crimson Text SemiBold'), local('CrimsonText-SemiBold'), url(https://fonts.gstatic.com/s/crimsontext/v8/wlppgwHKFkZgtmSR3NB0oRJXsCxGDNNV.ttf) format('truetype');\n}\n.login-container {\n  background-image: url('bg-pattern.jpg');\n  background-size: contain;\n  background-repeat: no-repeat;\n}\n.login-card {\n  margin-top: 100px;\n  background-color: rgba(255, 255, 255, 0.3);\n  height: 500px;\n}\n.login-card .card-body-wrapper {\n  height: 100%;\n  color: #333;\n}\n.login-card .card-body-wrapper .card-body .login-header {\n  font-family: 'Crimson Text', serif;\n  font-size: 50px;\n  font-weight: 600;\n}\n.login-card .card-body-wrapper .card-body .login-headline {\n  font-size: 20px;\n}\n.login-card .card-body-wrapper .card-body .form-group .form-control {\n  background-color: transparent;\n  border-color: transparent;\n  border-bottom: 1px solid #333;\n  border-radius: 0px;\n  color: #333;\n}\n.login-card .card-body-wrapper .card-body .form-group .form-control::-webkit-input-placeholder {\n  /* Chrome/Opera/Safari */\n  color: rgba(0, 0, 0, 0.7);\n}\n.login-card .card-body-wrapper .card-body .form-group .form-control::-moz-placeholder {\n  /* Firefox 19+ */\n  color: rgba(0, 0, 0, 0.7);\n}\n.login-card .card-body-wrapper .card-body .form-group .form-control:-ms-input-placeholder {\n  /* IE 10+ */\n  color: rgba(0, 0, 0, 0.7);\n}\n.login-card .card-body-wrapper .card-body .form-group .form-control:-moz-placeholder {\n  /* Firefox 18- */\n  color: rgba(0, 0, 0, 0.7);\n}\n.login-card .card-body-wrapper .card-body .btn-outline-default {\n  background-color: transparent;\n  border-color: #333;\n  color: #333;\n  border-radius: 0px;\n}\n.login-card .card-body-wrapper .card-body .btn-outline-default:hover {\n  border-color: #5B93E0;\n  background-color: #5B93E0;\n  color: #fff;\n}\n"
